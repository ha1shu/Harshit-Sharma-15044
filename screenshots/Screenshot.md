...
This folder is reserved for screenshots of the running local application.

The current container does not have the system libraries required by Chromium, so PNG capture could not be completed here. No placeholder images were added.
